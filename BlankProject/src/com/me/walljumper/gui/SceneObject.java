...
public abstract class SceneObject {
	...
	public void setToWrite(int index, String text, float fontOffsetX, float fontOffsetY, boolean usingScene){
		...
		if(usingScene){
			...
			WorldRenderer.renderer.displayToWorld(index, text, new Vector2(position.x + fontOffsetX, position.y + fontOffsetY));
